  ...
  switch (action.type) {
    ...
    case 'INCREMENT':
      return {
        ...
        // Lưu giá trị count cũ vào lịch sử
    ...
    // Đặt lại toàn bộ state về ban đầu
    case 'RESET':
      return initialState

    // Thay đổi giá trị step
    case 'SET_STEP':
      return {
        ...state,
        step: action.payload
...
export default function Ex02_CounterWithStep() {
  ...
  return (
    <Card className="mx-auto" style={{ maxWidth: 480 }}>
      <Card.Header>
        <strong>Bài 2 – Counter với Step & History</strong>
      </Card.Header>
